    ...
    if(!empty($grid['href'])){
        ...
        foreach($links as $link){
            ...
            if(preg_match('/^\[([a-z_]+)\]$/',$href,$matches)){
                ...
                if(strpos($href, 'setStatus') === false){
 ...
 * @return string 状态文字 ，false 未获取到
 */
function get_status_show($status = null,$type='Excel'){
    if(!isset($status)){
        return false;
    }
    if($type=='Excel') {
        ...
        switch ($status) {
            case 1  : return '已开通'; break;
            case 2  : return '未开通'; break;
            default : return false; break;
        }
    }
}
 ...
 * @param int $status
 * @return string 状态文字 ，false 未获取到
 * @author jamesyan <1920624985@qq.com>
 */
function get_status_borrow($status = null){
    if(!isset($status)){
        return false;
    }
    switch ($status){
        ...
        case 2  : return    '等待审核';   break;
        case 3  : return    '审核失败';   break;
        case 4  : return    '借款流标';   break;
        default : return    false;      break;
    }
}

function get_status_apply($status = null){
    if(!isset($status)){
        return false;
    }
    switch ($status){
        case 0  : return    '所有';     break;
        case 1  : return    '待查看';     break;
        case 2  : return    '信息无效';   break;
        case 3  : return    '待推进';   break;
        case 4  : return    '已完结';   break;
        default : return    false;      break;
    }
}